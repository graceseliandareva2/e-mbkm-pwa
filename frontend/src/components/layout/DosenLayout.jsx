...
const navItems = [
  ...
  { to: '/dosen/logbook',    icon: BookOpen,        label: 'Logbook' },
  { to: '/dosen/dokumen',    icon: FileText,        label: 'Dokumen' },
  { to: '/dosen/penilaian',  icon: Star,            label: 'Penilaian' },
  { to: '/dosen/biodata',    icon: User,            label: 'Biodata' },
]
...
export default function DosenLayout() {
  ...
  return (
    <div className="h-screen bg-gray-100 flex overflow-hidden">
      ...
      {/* Sidebar */}
      <aside
        className={`flex-shrink-0 w-56 h-screen flex flex-col z-30
      ...
      >
        ...
        <div className="p-3 border-t border-white/10">
          <button onClick={handleLogout}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-blue-100 hover:bg-white/10 hover:text-white w-full transition-all">
