...
const KaprodiDataMahasiswa = lazy(() => import('./pages/kaprodi/DataMahasiswa'))
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/mahasiswa" element={
            <ProtectedRoute allowedRoles={['mahasiswa']}><MahasiswaLayout /></ProtectedRoute>
          }>
          ...
          <Route path="/kaprodi" element={
            <ProtectedRoute allowedRoles={['kaprodi']}><KaprodiLayout /></ProtectedRoute>
          }>
